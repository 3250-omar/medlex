-- Migration: 20260915123000_private_session_admin_workflows.sql
-- Description: Security-definer admin workflows for slot creation, update, and withdrawal:
--              1. admin_create_private_session_slot
--              2. admin_update_private_session_slot
--              3. admin_withdraw_private_session_slot
--
-- NOTE: This file defines the original function signatures.
--       See 20260915127000_private_session_admin_workflows_fix.sql for the updated
--       versions that add p_admin_id and profile FK validation.
