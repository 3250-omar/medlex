-- Migration: 20260923000000_add_private_sessions_to_enrolled_courses.sql
-- Description: Update get_user_me_summary to include active/upcoming private sessions inside each enrolled course
...
begin
  ...
  -- 1. Aggregate enrolled courses with their respective active/upcoming private sessions
  select coalesce(
    jsonb_agg(
      jsonb_build_object(
        'enrollmentId', e.id,
