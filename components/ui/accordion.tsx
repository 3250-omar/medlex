...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="overflow-hidden text-sm transition-[height,opacity] duration-300 ease-out h-(--accordion-panel-height) data-ending-style:h-0 data-starting-style:h-0 data-ending-style:opacity-0 data-starting-style:opacity-0"
      {...props}
    >
      <div
        className={cn(
