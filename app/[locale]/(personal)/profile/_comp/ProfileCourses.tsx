...
export default function ProfileCourses({
  ...
  console.log("🚀 ~ ProfileCourses ~ courses:", courses);
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <h3 className="mt-2 font-serif text-xl font-normal text-white">
                      {title}
                    </h3>
                    {description && (
                  ...
                  {course.firstUnitSlug && (
                    <Link
                      href={`/${locale}/academy/courses/${course.slug}/learn/${course.currentUnitSlug}`}
